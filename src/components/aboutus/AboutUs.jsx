...
const AboutUs = () => {
    return (
        <div className="container py-[50px] about__us gap-[80px] flex flex-row lg:flex-row md:flex-col-reverse sm:flex-col-reverse lg:items-start sm:items-center md:items-center">
            <div className="aboutus__images relative flex flex-col gap-[24px]">
                <div className="flex gap-[24px]">
                    <img src={grid_1} alt="pic" className="grid-1" />
                    <div className="grid-1-div absolute left-[-20px] top-[-20px]"></div>
            ...
            <div className="aboutus__text min-h-full">
                ...
                <div className="aboutus-text-1 flex justify-around my-[100px] flex-col lg:flex-row md:flex-col sm:flex-col">
                    <div className="flex flex-col gap-[30px] justify-around items-center p-4">
                        <h1>+150</h1>
                        <p>Take orders</p>
                    </div>
                    <div className="flex flex-col gap-[30px] justify-around items-center p-4">
